...
def deal_cards():
    ...
    while player_total < 21:
        ...
        if continue_game == 'y':
            ...
            while computer_total < player_total:
...
start_game = True
while start_game:
    play_game = input("Would you like to play a game of blackjack? Press 'y' to play and 'n' to walk away \n")
    if play_game == 'y':
        print(deal_cards())
    elif play_game == 'n':
        start_game = False
        print("You made the smart decision, gambling is bad for you.")
    else:
        print("You entered in an invalid answer.")
